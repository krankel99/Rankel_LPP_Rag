...
class RAGAgent:
    ...
    def ask(self, question: str) -> dict:
        ...
        agent = Agent(
            role='AI Bubble Content Assistant',
            goal='Answer questions about AI Bubble using the database',
            backstory='You are an expert who has access to a database with content about the AI Bubble.',
            tools=[query_tool],
            llm=llm,
